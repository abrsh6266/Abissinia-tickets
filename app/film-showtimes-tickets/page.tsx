      ...
      <div className="sm:flex md:grid md:grid-cols-2">
        ...
        <div className="md:m-auto ml-2 relative h-10 w-72 min-w-[200px]">
          ...
          >
            ...
            <option value="Monday" style={{ color: "#000" }}>
              Monday
            </option>
            <option value="Tuesday" style={{ color: "#000" }}>
              Tuesday
            </option>
            <option value="Wednesday" style={{ color: "#000" }}>
              Wednesday
            </option>
            <option value="Thursday" style={{ color: "#000" }}>
              Thursday
            </option>
            <option value="Friday" style={{ color: "#000" }}>
              Friday
            </option>
            <option value="Saturday" style={{ color: "#000" }}>
              Saturday
            </option>
            <option value="Sunday" style={{ color: "#000" }}>
              Sunday
            </option>
          </select>
          <label
            ...
            style={{ color: "#fff" }} // Ensure label text color is white
          >
            Select Day ...
          </label>
        </div>
