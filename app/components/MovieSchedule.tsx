  ...
  return (
    <div className="mt-10 border-2 rounded p-2">
      ...
      <fieldset className="mt-4">
        <legend className="sr-only">Choose the time</legend>
        <div className="flex gap-4 lg:grid-cols-4">
            {
                showTime.map(time=>{
                    return <button key={time} className="overflow-hidden p-2 h-auto bg-black text-white border-none rounded-md text-xl font-bold cursor-pointer relative z-10 group">
                    {time}
