      ...
      <div className="grid lg:grid-cols-3 gap-12 p-6">
        <div className="lg:col-span-2  divide-y">
          <div className="flex items-start max-sm:flex-col gap-8 py-6">
            ...
            <div className="flex items-start gap-6 max-md:flex-col w-full">
              <div>
                ...
                <div>
                  <h6 className="text-md ">Size: <strong className="ml-2">7.5</strong></h6>
                  <h6 className="text-md  mt-2">Color: <strong className="ml-2">Black</strong></h6>
                </div>
                <div className="mt-6 flex flex-wrap gap-6">
                  <button type="button" className="font-semibold  text-sm flex items-center gap-2 shrink-0">
              ...
              <div className="md:ml-auto md:text-right">
                <div className="flex">
                  <button type="button" className="bg-transparent py-2 font-semibold ">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-3 fill-current" viewBox="0 0 124 124">
                      <path d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z" data-original="#000000"></path>
                    </svg>
                  </button>
                  <button type="button" className="bg-transparent mx-4 px-4 py-2 font-semibold  text-md border">
                    1
                  </button>
                  <button type="button" className="bg-transparent py-2 font-semibold ">
                ...
                <div className="mt-6">
                  <h4 className="text-lg font-bold "><p className=" mr-2 font-medium">$22.5</p></h4>
          ...
          <div className="flex items-start max-sm:flex-col gap-8 py-6">
            ...
            <div className="flex items-start gap-6 max-md:flex-col w-full">
              <div>
                <h3 className="text-xl font-extrabold  mb-6">Gray T-Shirt</h3>
                <div>
                  <h6 className="text-md ">Size: <strong className="ml-2">7.5</strong></h6>
                  <h6 className="text-md  mt-2">Color: <strong className="ml-2">Gray</strong></h6>
                </div>
                <div className="mt-6 flex flex-wrap gap-6">
                  <button type="button" className="font-semibold  text-sm flex items-center gap-2 shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 fill-current inline" viewBox="0 0 24 24">
          ...
          <div className="flex items-start max-sm:flex-col gap-8 py-6">
            ...
            <div className="flex items-start gap-6 max-md:flex-col w-full">
              ...
              <div className="md:ml-auto md:text-right">
                ...
                <div className="mt-6">
                  <h4 className="text-lg font-bold ">$22.5</h4>
                  <h4 className="text-lg font-bold  mt-2">$18.5</h4>
                </div>
              </div>
            </div>
